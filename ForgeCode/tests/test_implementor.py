...
# Simulated review with one error:
# the test uses a wrong expected output shape.
REVIEW = {
    "passed": False,
    "summary": (
        "The test asserts output shape (4, 10) "
        "but the spec requires 5 classes, "
        "so the expected shape should be (4, 5)."
    ),
    "issues": [
        {
            "severity": "error",
            ...
            "message": (
                "test_model.py asserts out.shape == (4, 10) "
                "but the spec requires 5 classes."
            ),
            "affected_files": [
                "tests/test_model.py"
            ...
            "recommendation": (
                "Change assertion to out.shape == (4, 5)"
            )
        }
    ],
    "checked_files": [
    ...
    "cross_file_inconsistencies": [
        "test_model.py shape (4, 10) vs "
        "model.py Linear output 5"
    ]
}
